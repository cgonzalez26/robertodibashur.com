	...
	<div class="container">
		...
		<div class="navbar-header">
				...
				//echo "aqui";
					...
					{
					$header_setting['height'] =60;
					$header_setting['width'] =300;
					?>
		...
		<?php 
				...
				//echo $header_setting['header_social_media_enabled'];	
				if($header_setting['header_social_media_enabled'] == 1 )
				{
					$social .= '<ul class="head-contact-social">';
					//echo $header_setting['social_media_facebook_link'];		
					if($header_setting['social_media_facebook_link'] != '') {
						//echo $header_setting['facebook_media_enabled'];
